...
class AccumulateModelAssemblyLineStrategyTest {
  ...
  public void
    ...
    // given
    given(modelOrderFactory.create(FIRST_MODEL_TYPE, FIRST_MODEL.getProductionTime()))
        .willReturn(FIRST_MODEL_ORDER);
    Order order = createAnOrderWithModel(FIRST_MODEL_ORDER);
    AccumulateModelAssemblyLineStrategy accumulateModelAssemblyLineStrategy =
        createAccumulateModelAssemblyLineStrategy();
    accumulateModelAssemblyLineStrategy.addOrder(order);
    ProductionTime expectedProductionTime = order.getModelOrder().getProductionTime();
  ...
  private void setUpThirdModelOrder() {
    given(modelOrderFactory.create(THIRD_MODEL_TYPE, THIRD_MODEL.getProductionTime()))
