...
public class AssemblyLineService extends AssemblyLineShutdownObservable
  ...
  public AssemblyLineService() {
    this(
        ...
        serviceLocator.resolve(AssemblyStrategy.class),
        serviceLocator.resolve(ModelOrderFactory.class),
        serviceLocator.resolve(BatteryOrderFactory.class),
  ...
  public void shutdown() {
    ...
    notifyProductionShutdown(getActiveOrders());
  }
